...
public class SabineNew6Stimulus extends Stimulus {
	private Polygon polygon;
	
	public SabineNew6Stimulus(String name, Color color, int width, int height) {
		...
		polygon.addPoint((int) (0.9*width), (int) (0.5*height));
		polygon.addPoint(width, (int) (0.5*height));
		polygon.addPoint(width, (int) (0.85*height));
		polygon.addPoint((int) (0.85*width), (int) (0.85*height));
		...
		polygon.addPoint(0, (int) (0.85*height));
		shape = polygon;
	}
	...
	public Stimulus factoryClone(Color color) {
		if(color==null) {
			return new SabineNew6Stimulus(name, this.color, width, height);
		} else {
			return new SabineNew6Stimulus(name, color, width, height);
		}
	}
